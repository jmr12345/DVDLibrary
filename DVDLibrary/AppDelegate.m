...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"Interrupted" object:self];
    NSLog(@">>>>>Incoming interruption detected");
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"Enter background" object:self];
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    [storyboard instantiateViewControllerWithIdentifier:@"libraryView"];
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    //resets the view back to the library so when user reopens the app after termination
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    [storyboard instantiateViewControllerWithIdentifier:@"libraryView"];
    NSLog(@">>>>>View set back to library before terminated");
